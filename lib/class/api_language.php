...
class api_language extends api {
    private $_list = array();
    ...
    public static function ls($data, $id, $token) {
        ...
        $r->data = parent::_ls($data, "language");
    ...
    public static function set($data, $id, $token) {
        ...
        $r->code = 0;
        $r->data = new stdClass();
        $r->data->id = parent::_set($data,"language");
		return $r;
    }
    ...
    public static function rm($data,$id,$token) {
        ...
        if ( parent::_rm($data,"language") ) $r->code = 0;
        return $r;
    }
}
?>