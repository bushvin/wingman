...
class api_currency extends api {
    private $_list = array();
    ...
    public static function ls($data, $id, $token) {
        ...
        $r->data = parent::_ls($data, "currency");
    ...
    public static function set($data, $id, $token) {
        ...
        $r->data = new stdClass();
        $r->code = 0;
        $r->data->id = parent::_set($data,"currency");
		return $r;
    }
    ...
    public static function rm($data,$id,$token) {
        ...
        if ( parent::_rm($data,"currency") ) $r->code = 0;
        return $r;
    }
}
?>