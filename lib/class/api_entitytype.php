...
class api_entitytype extends api {
    private $_list = array();
    ...
    public static function ls($data, $id, $token) {
        ...
        $r->data = parent::_ls($data, "entitytype");
    ...
    public static function set($data, $id, $token) {
        ...
        $r->code = 0;
        $r->data = new stdClass();
        $r->data->id = parent::_set($data,"entitytype");
		return $r;
    }
    ...
    public static function rm($data,$id,$token) {
        ...
        if ( parent::_rm($data,"entitytype") ) $r->code = 0;
        return $r;
    }
