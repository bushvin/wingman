...
class api_inventory extends api {
    private $_list = array();
    ...
    public static function ls($data, $id, $token) {
        ...
        $r->data = parent::_ls($data, "inventory");
    ...
    public static function set($data, $id, $token) {
        ...
        $r->code = 0;
        $r->data = new stdClass();
        $r->data->id = parent::_set($data,"inventory");
		return $r;
    }
    ...
    public static function rm($data,$id,$token) {
        ...
        if ( parent::_rm($data,"inventory") ) $r->code = 0;
        return $r;
    }
